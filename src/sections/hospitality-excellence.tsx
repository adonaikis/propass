...
export default function HospitalityExcellence() {
  return (
    <section id="excellence" className="bg-white px-4 py-16 text-black md:py-20">
      <div className="mx-auto grid max-w-[1180px] gap-12 min-[900px]:grid-cols-[430px_420px] min-[900px]:items-center min-[900px]:justify-center min-[900px]:gap-20 min-[1180px]:grid-cols-[560px_500px] min-[1180px]:justify-between min-[1180px]:gap-0">
        <div>
          ...
          <article className="grid min-h-[276px] gap-5 rounded-[24px] bg-zinc-50 p-3 shadow-[0_20px_60px_rgba(0,0,0,0.04)] sm:grid-cols-[186px_1fr] min-[1180px]:min-h-[342px] min-[1180px]:grid-cols-[245px_1fr] min-[1180px]:gap-6 min-[1180px]:p-4">
            ...
            <div className="flex min-h-[250px] flex-col justify-between py-4 pr-2 min-[1180px]:min-h-[310px] min-[1180px]:py-5">
              <div>
                ...
                <p className="mt-7 max-w-[230px] text-xs font-medium leading-5 text-zinc-600 min-[1180px]:max-w-[260px] min-[1180px]:text-[13px]">
                  Service rapide, assistance sur place et conciergerie virtuelle pour
                  rendre chaque séjour simple et agréable.
                </p>
              </div>
              ...
              <div className="flex items-end justify-between gap-4">
                <div>
                  ...
                  >
                    ...
                    <span className="grid size-6 place-items-center rounded-full bg-white text-black">
                      <ArrowUpRight className="size-3" strokeWidth={2.7} aria-hidden="true" />
                    </span>
                  </a>
                ...
                <div className="flex shrink-0 items-center gap-3">
                  ...
                  >
                    <ArrowLeft className="size-5" strokeWidth={2.1} aria-hidden="true" />
                  </button>
                  <button
                    type="button"
                  ...
                  >
                    <ArrowRight className="size-5" strokeWidth={2.1} aria-hidden="true" />
                  </button>
                </div>
              </div>
            </div>
        ...
        <div className="min-[900px]:pt-3">
          <h2 className="max-w-[390px] font-heading text-[35px] font-medium leading-[1.05] tracking-normal min-[1180px]:max-w-[500px] min-[1180px]:text-[44px]">
            ...
            <span className="ml-3 inline-flex h-8 w-28 translate-y-[-4px] items-center justify-end rounded-full border border-black px-3">
              <ArrowRight className="size-6" strokeWidth={1.8} aria-hidden="true" />
            </span>
          </h2>
          ...
          <div className="mt-8 grid gap-7 sm:grid-cols-[138px_1fr] sm:items-center min-[1180px]:mt-10 min-[1180px]:grid-cols-[180px_1fr] min-[1180px]:gap-9">
            ...
            <div className="max-w-[240px] min-[1180px]:max-w-[280px]">
              <Asterisk className="size-8 text-black min-[1180px]:size-10" strokeWidth={2.4} aria-hidden="true" />
