...
function ImageCard({
  ...
  return (
    <article className={`group relative overflow-hidden rounded-[18px] bg-black ${className}`}>
      <Image
        src={src}
        alt={alt}
        fill
  ...
  return (
    <section id="about" className="bg-white px-4 py-8 text-black md:py-10">
      <div className="mx-auto max-w-[1180px]">
        ...
        <h2 className="mx-auto mt-7 max-w-[620px] text-center font-heading text-[32px] font-medium leading-[1.08] tracking-normal md:text-[34px]">
          Explorez nos séjours, votre confort, votre priorité
        </h2>

        <div className="mt-10 grid gap-8 min-[860px]:grid-cols-[240px_320px_250px] min-[860px]:items-center min-[860px]:justify-center min-[860px]:gap-7 min-[1180px]:grid-cols-[300px_410px_330px] min-[1180px]:gap-8">
          <div className="max-w-[260px] min-[1180px]:max-w-[300px]">
            ...
            <p className="mt-5 text-[20px] font-semibold leading-[1.18] tracking-[-0.01em]">
              Propass est une adresse de confiance qui relie les voyageurs aux meilleurs
              séjours à Kinshasa.
            </p>
          ...
          >
            <p className="absolute bottom-14 left-4 max-w-[235px] text-[16px] font-medium leading-[1.08] text-white">
              Une expérience raffinée, pensée pour le repos, le travail et chaque moment
              important.
            </p>
            ...
            >
              <ArrowUpRight className="size-5" strokeWidth={2.5} aria-hidden="true" />
            </button>
          </ImageCard>

          <div className="min-[860px]:pt-10">
            <ImageCard
            ...
            <div className="mt-6 flex items-end justify-between gap-5">
              <p className="max-w-[235px] text-[12px] font-medium leading-4 text-zinc-700 min-[1180px]:max-w-[255px]">
                Découvrez une destination où confort, relaxation et luxe se rencontrent
        ...
        <div className="mt-16 h-px w-full bg-zinc-200" />
      </div>
    </section>
  );
}
